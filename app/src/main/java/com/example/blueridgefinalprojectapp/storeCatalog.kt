...
import com.example.blueridgefinalprojectapp.components.CatalogItemCard
...
import com.example.blueridgefinalprojectapp.data.getDemoBookstoreCatalogItemList
...
fun storeCatalog(
    ...
    val catalogItemList = getDemoBookstoreCatalogItemList(context)
    ...
    Column(
        ...
        Column(
            ...
            LazyColumn {
                items(catalogItemList) { catalogItem ->
                    CatalogItemCard(
                        catalogItem
                    )
                }
...
@Composable
private fun storeCatalogPreview() {
    AppTheme {
